package com.breezefieldsaleszazuteam.features.dashboard.presentation
...
import com.breezefieldsaleszazuteam.*
import com.breezefieldsaleszazuteam.R
import com.breezefieldsaleszazuteam.app.*
import com.breezefieldsaleszazuteam.app.NewFileUtils.browseDocuments
import com.breezefieldsaleszazuteam.app.NewFileUtils.browsePDFDocuments
import com.breezefieldsaleszazuteam.app.NewFileUtils.getExtension
import com.breezefieldsaleszazuteam.app.domain.*
import com.breezefieldsaleszazuteam.app.types.DashboardType
import com.breezefieldsaleszazuteam.app.types.FragType
import com.breezefieldsaleszazuteam.app.types.TopBarConfig
import com.breezefieldsaleszazuteam.app.uiaction.DisplayAlert
import com.breezefieldsaleszazuteam.app.utils.*
import com.breezefieldsaleszazuteam.app.utils.AppUtils.Companion.isProfile
import com.breezefieldsaleszazuteam.base.BaseResponse
import com.breezefieldsaleszazuteam.base.presentation.BaseActivity
import com.breezefieldsaleszazuteam.base.presentation.BaseFragment
import com.breezefieldsaleszazuteam.features.NewQuotation.*
import com.breezefieldsaleszazuteam.features.NewQuotation.api.GetQuotRegProvider
import com.breezefieldsaleszazuteam.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezefieldsaleszazuteam.features.SearchLocation.SearchLocationFragment
import com.breezefieldsaleszazuteam.features.SearchLocation.locationInfoModel
import com.breezefieldsaleszazuteam.features.TA.ViewAllTAListFragment
import com.breezefieldsaleszazuteam.features.achievement.AchievementFragment
import com.breezefieldsaleszazuteam.features.activities.presentation.*
import com.breezefieldsaleszazuteam.features.addAttendence.*
import com.breezefieldsaleszazuteam.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefieldsaleszazuteam.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefieldsaleszazuteam.features.addAttendence.model.GetReportToFCMResponse
import com.breezefieldsaleszazuteam.features.addAttendence.model.GetReportToResponse
import com.breezefieldsaleszazuteam.features.addAttendence.model.Leave_list_Response
import com.breezefieldsaleszazuteam.features.addorder.presentation.AddOrderFragment
...
import com.breezefieldsaleszazuteam.features.addshop.presentation.AddShopFragment
import com.breezefieldsaleszazuteam.features.addshop.presentation.OTPVerificationDialog
import com.breezefieldsaleszazuteam.features.addshop.presentation.ScanImageFragment
import com.breezefieldsaleszazuteam.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefieldsaleszazuteam.features.alarm.model.AlarmData
import com.breezefieldsaleszazuteam.features.alarm.presetation.AttendanceReportFragment
import com.breezefieldsaleszazuteam.features.alarm.presetation.PerformanceReportFragment
import com.breezefieldsaleszazuteam.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefieldsaleszazuteam.features.alarm.presetation.VisitReportFragment
import com.breezefieldsaleszazuteam.features.attendance.AttendanceFragment
import com.breezefieldsaleszazuteam.features.attendance.api.AttendanceRepositoryProvider
import com.breezefieldsaleszazuteam.features.attendance.model.AttendanceRequest
import com.breezefieldsaleszazuteam.features.attendance.model.AttendanceResponse
import com.breezefieldsaleszazuteam.features.averageshop.presentation.AverageShopFragment
import com.breezefieldsaleszazuteam.features.avgorder.presentation.AverageOrderFragment
import com.breezefieldsaleszazuteam.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefieldsaleszazuteam.features.beatCustom.TeamBeatListFragment
import com.breezefieldsaleszazuteam.features.billing.presentation.AddBillingFragment
import com.breezefieldsaleszazuteam.features.billing.presentation.BillingDetailsFragment
import com.breezefieldsaleszazuteam.features.billing.presentation.BillingListFragment
import com.breezefieldsaleszazuteam.features.changepassword.presentation.ChangePasswordDialog
import com.breezefieldsaleszazuteam.features.chat.model.ChatListDataModel
import com.breezefieldsaleszazuteam.features.chat.model.ChatUserDataModel
import com.breezefieldsaleszazuteam.features.chat.model.GroupUserDataModel
import com.breezefieldsaleszazuteam.features.chat.presentation.*
import com.breezefieldsaleszazuteam.features.chatbot.presentation.ChatBotFragment
import com.breezefieldsaleszazuteam.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefieldsaleszazuteam.features.chatbot.presentation.ReportsFragment
import com.breezefieldsaleszazuteam.features.chatbot.presentation.SelectLanguageDialog
import com.breezefieldsaleszazuteam.features.commondialog.presentation.CommonDialog
import com.breezefieldsaleszazuteam.features.commondialog.presentation.CommonDialogClickListener
import com.breezefieldsaleszazuteam.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezefieldsaleszazuteam.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezefieldsaleszazuteam.features.commondialogsinglebtn.OnDialogClickListener
import com.breezefieldsaleszazuteam.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefieldsaleszazuteam.features.contacts.ContactDtls
import com.breezefieldsaleszazuteam.features.contacts.ContactGr
import com.breezefieldsaleszazuteam.features.contacts.ContactsAddFrag
import com.breezefieldsaleszazuteam.features.contacts.ContactsFrag
import com.breezefieldsaleszazuteam.features.contacts.SchedulerViewFrag
import com.breezefieldsaleszazuteam.features.contacts.SchedulerAddFormFrag
import com.breezefieldsaleszazuteam.features.contacts.TemplateAddFrag
import com.breezefieldsaleszazuteam.features.contacts.TemplateViewFrag
import com.breezefieldsaleszazuteam.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefieldsaleszazuteam.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefieldsaleszazuteam.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefieldsaleszazuteam.features.damageProduct.ShopDamageProductListFrag
import com.breezefieldsaleszazuteam.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezefieldsaleszazuteam.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezefieldsaleszazuteam.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezefieldsaleszazuteam.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezefieldsaleszazuteam.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezefieldsaleszazuteam.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefieldsaleszazuteam.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezefieldsaleszazuteam.features.dashboard.presentation.model.ContentListResponseModel
import com.breezefieldsaleszazuteam.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezefieldsaleszazuteam.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezefieldsaleszazuteam.features.device_info.presentation.DeviceInfoListFragment
import com.breezefieldsaleszazuteam.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefieldsaleszazuteam.features.document.DocumentRepoFeatureNewFragment
import com.breezefieldsaleszazuteam.features.document.presentation.DocumentListFragment
import com.breezefieldsaleszazuteam.features.document.presentation.DocumentTypeListFragment
import com.breezefieldsaleszazuteam.features.document.presentation.OpenFileWebViewFragment
import com.breezefieldsaleszazuteam.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefieldsaleszazuteam.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefieldsaleszazuteam.features.dymanicSection.presentation.DynamicListFragment
import com.breezefieldsaleszazuteam.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefieldsaleszazuteam.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefieldsaleszazuteam.features.home.presentation.HomeFragment
import com.breezefieldsaleszazuteam.features.homelocation.presentation.HomeLocationFragment
import com.breezefieldsaleszazuteam.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefieldsaleszazuteam.features.know_your_state.KnowYourStateFragment
import com.breezefieldsaleszazuteam.features.lead.LeadFrag
import com.breezefieldsaleszazuteam.features.lead.ViewLeadFrag
import com.breezefieldsaleszazuteam.features.leaderboard.LeaderBoardFrag
import com.breezefieldsaleszazuteam.features.leaveapplynew.LeaveHome
import com.breezefieldsaleszazuteam.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefieldsaleszazuteam.features.localshops.LocalShopListFragment
import com.breezefieldsaleszazuteam.features.localshops.LocalShopListMapFragment
import com.breezefieldsaleszazuteam.features.localshops.NearByShopsMapFragment
import com.breezefieldsaleszazuteam.features.location.*
import com.breezefieldsaleszazuteam.features.location.api.LocationRepoProvider
import com.breezefieldsaleszazuteam.features.location.model.*
import com.breezefieldsaleszazuteam.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezefieldsaleszazuteam.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezefieldsaleszazuteam.features.login.ShopFeedbackEntity
import com.breezefieldsaleszazuteam.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezefieldsaleszazuteam.features.login.presentation.LoginActivity
import com.breezefieldsaleszazuteam.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezefieldsaleszazuteam.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefieldsaleszazuteam.features.marketAssist.MarketAssistTabFrag
import com.breezefieldsaleszazuteam.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezefieldsaleszazuteam.features.marketAssist.ShopListMarketAssistFrag
import com.breezefieldsaleszazuteam.features.marketing.presentation.MarketingPagerFragment
import com.breezefieldsaleszazuteam.features.meetinglist.prsentation.MeetingListFragment
import com.breezefieldsaleszazuteam.features.member.MapViewForTeamFrag
import com.breezefieldsaleszazuteam.features.member.model.TeamLocDataModel
import com.breezefieldsaleszazuteam.features.member.model.TeamShopListDataModel
import com.breezefieldsaleszazuteam.features.member.presentation.*
import com.breezefieldsaleszazuteam.features.menuBeat.MenuBeatFrag
import com.breezefieldsaleszazuteam.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefieldsaleszazuteam.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefieldsaleszazuteam.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefieldsaleszazuteam.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefieldsaleszazuteam.features.myjobs.model.CustomerDataModel
import com.breezefieldsaleszazuteam.features.myjobs.presentation.*
import com.breezefieldsaleszazuteam.features.myorder.presentation.MyOrderListFragment
import com.breezefieldsaleszazuteam.features.myprofile.presentation.MyProfileFragment
import com.breezefieldsaleszazuteam.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezefieldsaleszazuteam.features.nearbyshops.model.ShopData
import com.breezefieldsaleszazuteam.features.nearbyshops.model.ShopListResponse
import com.breezefieldsaleszazuteam.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefieldsaleszazuteam.features.nearbyshops.presentation.BeatListFragment
import com.breezefieldsaleszazuteam.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefieldsaleszazuteam.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefieldsaleszazuteam.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezefieldsaleszazuteam.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefieldsaleszazuteam.features.newcollection.CollectionDetailsStatusFragment
import com.breezefieldsaleszazuteam.features.newcollection.CollectionShopListFragment
import com.breezefieldsaleszazuteam.features.newcollection.NewCollectionListFragment
import com.breezefieldsaleszazuteam.features.newcollectionreport.*
import com.breezefieldsaleszazuteam.features.notification.NotificationFragment
import com.breezefieldsaleszazuteam.features.orderList.NewDateWiseOrderListFragment
import com.breezefieldsaleszazuteam.features.orderList.NewOrderListFragment
import com.breezefieldsaleszazuteam.features.orderList.OrderListFragment
import com.breezefieldsaleszazuteam.features.orderdetail.presentation.OrderDetailFragment
import com.breezefieldsaleszazuteam.features.orderhistory.ActivityMapFragment
import com.breezefieldsaleszazuteam.features.orderhistory.OrderhistoryFragment
import com.breezefieldsaleszazuteam.features.orderhistory.TimeLineFragment
import com.breezefieldsaleszazuteam.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.breezefieldsaleszazuteam.features.orderhistory.model.LocationData
import com.breezefieldsaleszazuteam.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefieldsaleszazuteam.features.performance.GpsStatusFragment
import com.breezefieldsaleszazuteam.features.performance.PerformanceFragment
import com.breezefieldsaleszazuteam.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezefieldsaleszazuteam.features.performance.model.UpdateGpsInputParamsModel
import com.breezefieldsaleszazuteam.features.performanceAPP.OwnPerformanceFragment
import com.breezefieldsaleszazuteam.features.performanceAPP.PerformanceAppFragment
import com.breezefieldsaleszazuteam.features.performanceAPP.allPerformanceFrag
import com.breezefieldsaleszazuteam.features.permissionList.ViewPermissionFragment
import com.breezefieldsaleszazuteam.features.photoReg.*
import com.breezefieldsaleszazuteam.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefieldsaleszazuteam.features.quotation.presentation.*
import com.breezefieldsaleszazuteam.features.reimbursement.presentation.*
import com.breezefieldsaleszazuteam.features.report.presentation.*
import com.breezefieldsaleszazuteam.features.returnsOrder.*
import com.breezefieldsaleszazuteam.features.settings.presentation.SettingsFragment
import com.breezefieldsaleszazuteam.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefieldsaleszazuteam.features.shopdetail.presentation.*
import com.breezefieldsaleszazuteam.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldsaleszazuteam.features.stock.StockDetailsFragment
import com.breezefieldsaleszazuteam.features.stock.StockListFragment
import com.breezefieldsaleszazuteam.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefieldsaleszazuteam.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefieldsaleszazuteam.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefieldsaleszazuteam.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezefieldsaleszazuteam.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefieldsaleszazuteam.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefieldsaleszazuteam.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefieldsaleszazuteam.features.survey.SurveyFrag
import com.breezefieldsaleszazuteam.features.survey.SurveyViewDtlsFrag
import com.breezefieldsaleszazuteam.features.survey.SurveyViewFrag
import com.breezefieldsaleszazuteam.features.task.presentation.AddTaskFragment
import com.breezefieldsaleszazuteam.features.task.presentation.CalenderTaskFragment
import com.breezefieldsaleszazuteam.features.task.presentation.EditTaskFragment
import com.breezefieldsaleszazuteam.features.task.presentation.TaskListFragment
import com.breezefieldsaleszazuteam.features.taskManagement.TaskManagementFrag
import com.breezefieldsaleszazuteam.features.taskManagement.ViewTaskManagementFrag
import com.breezefieldsaleszazuteam.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefieldsaleszazuteam.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefieldsaleszazuteam.features.timesheet.presentation.TimeSheetListFragment
import com.breezefieldsaleszazuteam.features.viewAllOrder.CartFragment
import com.breezefieldsaleszazuteam.features.viewAllOrder.OrderTypeListFragment
import com.breezefieldsaleszazuteam.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefieldsaleszazuteam.features.viewAllOrder.ViewCartFragment
import com.breezefieldsaleszazuteam.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefieldsaleszazuteam.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefieldsaleszazuteam.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezefieldsaleszazuteam.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezefieldsaleszazuteam.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezefieldsaleszazuteam.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefieldsaleszazuteam.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefieldsaleszazuteam.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefieldsaleszazuteam.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefieldsaleszazuteam.features.viewPPDDStock.ViewStockFragment
import com.breezefieldsaleszazuteam.features.weather.presentation.WeatherFragment
import com.breezefieldsaleszazuteam.mappackage.MapActivity
import com.breezefieldsaleszazuteam.mappackage.MapActivityWithoutPath
import com.breezefieldsaleszazuteam.mappackage.SendBrod
import com.breezefieldsaleszazuteam.widgets.AppCustomEditText
import com.breezefieldsaleszazuteam.widgets.AppCustomTextView
...
//            Log.w(TAG, errorMessage);
    ...
    override fun loadFragment(mFragType: FragType, addToStack: Boolean, initializeObject: Any) {
        ...
        println("load_frag " + mFragType.toString() + " " + Pref.user_id.toString()+" " + Pref.AdditionalinfoRequiredforContactListing.toString())
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezefieldsaleszazuteamlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsaleszazuteamlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.breezefieldsaleszazuteam/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsaleszazuteamlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsaleszazuteamlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsaleszazuteamlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsaleszazuteamlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
