package com.breezefieldsaleszazuteam.features.logoutsync.presentation
...
import com.breezefieldsaleszazuteam.app.AppDatabase
...
import com.breezefieldsaleszazuteam.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldsaleszazuteam.features.billing.api.AddBillingRepoProvider
import com.breezefieldsaleszazuteam.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldsaleszazuteam.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldsaleszazuteam.features.document.model.AddEditDocumentInputParams
import com.breezefieldsaleszazuteam.features.document.model.DocumentAttachmentModel
...
import com.breezefieldsaleszazuteam.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezefieldsaleszazuteam.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezefieldsaleszazuteam.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefieldsaleszazuteam.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldsaleszazuteam.features.orderhistory.model.*
...
import com.breezefieldsaleszazuteam.features.quotation.model.AddQuotInputModel
import com.breezefieldsaleszazuteam.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldsaleszazuteam.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldsaleszazuteam.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefieldsaleszazuteam.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefieldsaleszazuteam.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldsaleszazuteam.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldsaleszazuteam.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldsaleszazuteam.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldsaleszazuteam.mappackage.SendBrod
import com.breezefieldsaleszazuteam.widgets.AppCustomTextView
import com.breezefieldsaleszazuteam.MonitorService
import com.breezefieldsaleszazuteam.MySingleton
...
import com.breezefieldsaleszazuteam.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefieldsaleszazuteam.features.login.model.GetConcurrentUserResponse
import com.breezefieldsaleszazuteam.features.login.model.WhatsappApiData
import com.breezefieldsaleszazuteam.features.performance.model.Gps_status_list
import com.breezefieldsaleszazuteam.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldsaleszazuteam.features.returnsOrder.ReturnProductList
import com.breezefieldsaleszazuteam.features.returnsOrder.ReturnRequest
import com.breezefieldsaleszazuteam.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsaleszazuteamlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsaleszazuteamlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsaleszazuteamlogsample/log.zip").path);
